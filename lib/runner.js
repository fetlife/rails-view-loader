...
const run = (loader, source, config, map, callback) => {
...
const retryRun = (loader, source, config, map, callback) => {
  ...
  operation.attempt((currentAttempt) => {
    ...
    run(loader, source, config, map, (error, output, map) => {
...
module.exports = (loader, source, config, map, callback) => {
  retryRun(loader, source, config, map, callback)
}
